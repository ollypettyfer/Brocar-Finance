    ...
    <>
      <div className="section has-text-centered" id="scroll-to-fluent">
        <div className="container">
          <div className=" title is-3 title-edit">Fluent In Finance</div>
          <div className="">
            ...
            Brocar finance arranging a tailored finance solution to meet your
            needs is our priority. We leave the car dealerships to supply the
